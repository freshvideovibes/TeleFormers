      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">Talent-Sourcing</h4>
                  <p className="text-gray-300">Wir finden die besten Talente für Ihre spezifischen Anforderungen</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">Maßgeschneiderte Ausbildung</h4>
                  <p className="text-gray-300">Spezialtraining für Ihre Branche und Produkte</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">Qualitätsmanagement</h4>
                  <p className="text-gray-300">Kontinuierliche Überwachung und Optimierung der Leistung</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">Schnelle Bereitstellung</h4>
                  <p className="text-gray-300">Einsatzbereite Talente innerhalb von 48 Stunden</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-500/10 to-blue-500/10 p-8 rounded-xl border border-orange-500/20">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">Reduzierte Personalkosten um 40%</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-300">Flexible Skalierung nach Bedarf</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-300">Keine langfristigen Verträge</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-300">24/7 Verfügbarkeit</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-300">Detaillierte Performance-Reports</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-slate-700 p-6 rounded-xl">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Kundenservice</h3>
            <ul className="text-gray-300 text-sm space-y-2">
              <li>• Professionelle Kundenbetreuung</li>
          ...
          <div className="bg-slate-700 p-6 rounded-xl">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Vertrieb</h3>
            <ul className="text-gray-300 text-sm space-y-2">
              <li>• Outbound/Inbound Sales</li>
          ...
          <div className="bg-slate-700 p-6 rounded-xl">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Marktforschung</h3>
            <ul className="text-gray-300 text-sm space-y-2">
              <li>• Umfragen & Interviews</li>
              <li>• Datenanalyse</li>
