      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Kontaktieren Sie <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-orange-500">uns</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-300 mb-8">
              Egal ob Sie als Talent bei uns starten möchten oder als Unternehmen qualifizierte Mitarbeiter suchen - 
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Musterstraße 123<br />12345 Musterstadt</p>
                </div>
              </div>
            </div>
          </div>
